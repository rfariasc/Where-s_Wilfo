...
inline cv::Mat QImageToCvMat(QImage const& inImage, bool inCloneImageData = true )
{
    std::cout<<inImage.format()<<endl;
    ...
    case QImage::Format_RGB32:
    {
        ...
        cv::Mat mat = cv::Mat( inImage.height(), inImage.width(),
                      CV_8SC4, (uchar*)(inImage.bits()), inImage.bytesPerLine());
